...
/// <summary>
/// Represent a snapshot from <see cref="RingBuffer{T}"/> instance.
/// </summary>
/// <typeparam name="T">Same with the <see cref="RingBuffer{T}"/>.</typeparam>
internal ref struct RingBufferSnapshot<T>: IEnumerator<T> {
    ...
    public RingBufferSnapshot(ReadOnlySpan<T> buffer) {
